    ...
    <div className="App">
      ...
      <div id="about" className="container d-flex justify-content-center align-content-center bg-light text-center" style={{ height: "350px" }}>
        <div className="row d-flex justify-content-center " style={{ paddingTop: "20px" }}>
          ...
          <p style={{ fontFamily: "sans-serif" }}>I am a Bsc IT Graduate with a penchant for design and storytelling. I am passionate about enhancing user experience and maximizing user interface.</p>
        </div>
      </div>
